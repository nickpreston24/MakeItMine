 ...
 */
recipeRepo.prototype.seed = function () {
 ...
 * @param {*} recipe 
 */
recipeRepo.prototype.add = function (recipe) {
 ...
 * @param {*} directions 
 */
recipeRepo.prototype.write = function (name, ingredients, directions, starred) {
 ...
 * @param {*} recipe 
 */
recipeRepo.prototype.performUpdates = function (newRecipeKey, recipe) {
 ...
 * @param {*} uniqueId 
 */
recipeRepo.prototype.find = async function (uniqueId) {
 ...
 * @param {*} predicate 
 */
recipeRepo.prototype.get = async function (predicate) {
 ...
 * @param {*} recipe 
 */
recipeRepo.prototype.amend = async function (recipe) {
 ...
 * @param {*} recipe 
 */
recipeRepo.prototype.remove = async function (recipe) {
